...
const libTable = (() => { // eslint-disable-line no-unused-vars
    ...
    // ==================================================
    //const handleItem = (o) => {
    //    let tbl = getObj('rollabletable', o.get('_rollabletableid'));

    //    delete tablesByName[tbl.get('name')];
    //    delete tables[tbl.id];

    //    flattenTable(tbl);

    //};
    //const handleTable = (o, p) => {
    //    if (p && tablesByName[p.name]) delete tablesByName[p.name];
    //    else delete tablesByName[o.get('name')];
    //    delete tables[o.id];
    //    let tbl = getObj('rollabletable', o.id);
    //    if (tbl) flattenTable(tbl);
    //};
    ...
    //    on('add:rollabletable', handleTable);
    //    on('change:rollabletable', handleTable);
    //    on('destroy:rollabletable', handleTable);
    //    on('add:tableitem', handleItem);
    //    on('change:tableitem', handleItem);
    //    on('destroy:tableitem', handleItem);
    //};
